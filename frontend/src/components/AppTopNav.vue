                ...
                <div :class="menu ? 'opacity-100 translate-y-20':'opacity-0 -translate-y-40'" class="absolute top-0 left-0 w-full duration-300 md:relative md:top-0 md:contents">
                    <div class="flex gap-2 justify-end bg-white p-4 w-full md:p-0 md:bg-transparent">
                        <div class="flex gap-2">
                            ...
                            <a href="http://127.0.0.1:8000/admin" target="_blank" class="text-sm text-slate-700 font-bold rounded-md border border-rose-600 py-2 px-4 tracking-wide transition-all duration-200 capitalize hover:bg-rose-600 hover:text-white">Admin</a>
                        </div>
                        <div class="flex">
