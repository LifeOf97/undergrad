            ...
            <span class="flex flex-col gap-8 mt-4 ml-10">
                ...
                <div class="flex items-center justify-between border-t pt-2">
                    ...
                    <div class="flex gap-3">
                        <AppButton @click.prevent="update ? '':actionUpdateSchedule({id: schedule.id, completed: completed})" :name="'Update'" :type="'plain'" :disabled="update" />
...
export default {
    ...
    props: { schedule: {type: Object, required: false}, },
    ...
    watch: {
        completed(newVal) {
            if (this.schedule.completed === newVal) {
                this.update = true
            }
            else {
                this.update = false
