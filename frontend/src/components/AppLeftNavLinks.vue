<template>
    <div class="h-full flex flex-col justify-between">
        ...
        <div class="flex flex-col gap-4">
            <router-link @click="actionUpdateNav({state: false})" :to="{name: 'dashboard'}" active-class="text-slate-50 bg-slate-500" class="group flex items-center text-slate-600 gap-3 rounded-lg p-2 transition-all duration-150 hover:bg-slate-500">
            ...
            <router-link @click="actionUpdateNav({state: false})" :to="{name: 'myschedules'}" active-class="text-slate-50 bg-slate-500" class="group flex items-center text-slate-600 gap-3 rounded-lg p-2 transition-all duration-150 hover:bg-slate-500">
                <svg class="w-6 h-6 fill-current group-hover:text-slate-50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <router-link @click="actionUpdateNav({state: false})" :to="{name: 'mystudents'}" active-class="text-slate-50 bg-slate-500" class="group flex items-center text-slate-600 gap-3 rounded-lg p-2 transition-all duration-150 hover:bg-slate-500">
                <svg class="w-6 h-6 fill-current group-hover:text-slate-50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
