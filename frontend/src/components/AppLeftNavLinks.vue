<template>
    <div class="h-full flex flex-col justify-between">
        ...
        <div class="flex flex-col space-y-4">
            <router-link to="" class="group flex items-center space-x-4 rounded-lg p-2 transition-all duration-150 hover:bg-blueGray-500">
                <svg class="w-6 h-6 fill-current text-blueGray-900 group-hover:text-blueGray-50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 21H13V15H21V21ZM11 21H3V11H11V21ZM21 13H13V3H21V13ZM11 9H3V3H11V9Z"></path>
                </svg>
                <p class="text-sm text-blueGray-600 group-hover:text-blueGray-50">Dashboard</p>
            </router-link>
            <router-link to="" class="group flex items-center space-x-4 rounded-lg p-2 transition-all duration-150 hover:bg-blueGray-500">
                <svg class="w-6 h-6 fill-current text-blueGray-900 group-hover:text-blueGray-50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="text-sm text-blueGray-600 group-hover:text-blueGray-50">My Schedules</p>
            </router-link>
            <router-link to="" class="group flex items-center space-x-4 rounded-lg p-2 transition-all duration-150 hover:bg-blueGray-500">
                <svg class="w-6 h-6 fill-current text-blueGray-900 group-hover:text-blueGray-50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="text-sm text-blueGray-600 group-hover:text-blueGray-50">My Students</p>
            </router-link>
        </div>
        <!-- end of nav links -->
        ...
        <div>
            <router-link to="" class="group flex items-center space-x-4 rounded-lg p-2 transition-all duration-150 hover:bg-blueGray-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 stroke-current text-blueGray-900 group-hover:text-blueGray-50" fill="none" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
                <p class="text-sm text-blueGray-600 group-hover:text-blueGray-50">Sign out</p>
            </router-link>
        </div>
        <!-- end of sign out -->
